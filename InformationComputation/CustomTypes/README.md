...
- [1. Custom types](#1-custom-types)
  ...
  - [1.3. Type Concept](#13-type-concept)
    ...
    - [1.3.3. Complex Types](#133-complex-types)
  ...
  - [1.7. `struct` versus `class` Definition](#17-struct-versus-class-definition)
  - [1.8. Value Types Modification](#18-value-types-modification)
  - [1.9. Reference Types Comparison](#19-reference-types-comparison)
  - [1.10. Reference Type Modification](#110-reference-type-modification)
  - [1.11. Value and Reference Types Summary](#111-value-and-reference-types-summary)
...
## 1.7. `struct` versus `class` Definition
...
## 1.10. Reference Type Modification
...
## 1.11. Value and Reference Types Summary
