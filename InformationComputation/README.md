...
- [1. Computation of Information](#1-computation-of-information)
  ...
  - [1.2. Executive Summary](#12-executive-summary)
    - [1.2.1. Welcome](#121-welcome)
    - [1.2.2. Instructor Intro](#122-instructor-intro)
  ...
  - [1.3. Information versus data](#13-information-versus-data)
    ...
    - [1.3.3. Introduction to Title Explanation](#133-introduction-to-title-explanation)
    - [1.3.4. First Problem](#134-first-problem)
    - [1.3.5. First Conclusion](#135-first-conclusion)
    - [1.3.6. Fundamental Inconsistency](#136-fundamental-inconsistency)
    - [1.3.7. Syntax Analysis](#137-syntax-analysis)
    - [1.3.8. Semantics analysis](#138-semantics-analysis)
    - [1.3.9. Data Definition](#139-data-definition)
    - [1.3.10. Coding System](#1310-coding-system)
...
I would like to invite you to participate in the next lesson of the course titled Information Computation. The main goal of this lesson is to explain the meaning of the course title to create a starting point to improve your further understanding.

### 1.3.2. What's the problem?

- how to use a physical device (computer) to process abstraction (information)
...
### 1.3.3. Introduction to Title Explanation
...
### 1.3.11. Possibility to Replace Information by Data
