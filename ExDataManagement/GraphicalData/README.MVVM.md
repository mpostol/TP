...
- [4. Layered Architecture](#4-layered-architecture)
  ...
  - [4.2. MVVM as Sub-layers of the Presentation Layer](#42-mvvm-as-sub-layers-of-the-presentation-layer)
  - [4.3. MVVM Implementation Using Project Concept](#43-mvvm-implementation-using-project-concept)
  - [4.4. MVVM implementation Conclusion](#44-mvvm-implementation-conclusion)
  - [4.5. Layered architecture Benefits](#45-layered-architecture-benefits)
  - [4.6. View - Inversion of Control](#46-view---inversion-of-control)
- [5. Bindings - User Interface Interoperability](#5-bindings---user-interface-interoperability)
  - [5.1. Coupling Controls with Data](#51-coupling-controls-with-data)
  - [5.2. DataContext](#52-datacontext)
  - [5.3. Binding](#53-binding)
  - [5.4. INotifyPropertyChange](#54-inotifypropertychange)
  - [5.5. ICommand](#55-icommand)
...
[MainWindow.xaml]: https://github.com/mpostol/TP/blob/5.13-India/ExDataManagement/GraphicalData/GraphicalData.View/MainWindow.xaml#L1-L46
...
### 4.2. MVVM as Sub-layers of the Presentation Layer
...
### 4.3. MVVM Implementation Using Project Concept
...
### 4.4. MVVM implementation Conclusion
...
### 4.5. Layered architecture Benefits
...
## 5. Bindings - User Interface Interoperability

### 5.1. Coupling Controls with Data
