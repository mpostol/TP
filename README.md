# csharp (C#) Teaching Programming (TP)
...
education, training, code examples, csharp, csharp-examples, data-intensive-programming, data management, information processing, data processing, adaptive-programming, 
...
Turning today's students into tomorrow's advanced software developer.
